...
@Component({
    moduleId: module.id,
    selector: 'TravelodeActionBar',
    templateUrl: './travelode-action-bar.component.html',
    styleUrls: ['./travelode-action-bar.component.scss']
})
export class TravelodeActionBarComponent{
