...
@Component({
    selector: "TravelodeDefault",
    moduleId: module.id,
    templateUrl: "./travelode-default.component.html",
    styleUrls: ["./travelode-default.component.scss"]
})
export class TravelodeDefaultComponent implements OnInit{
